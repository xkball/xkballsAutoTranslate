...
//    public static String LLM_MODEL_CONFIGURATION ublic
    ...
    public static final ModConfigSpec.ConfigValue<TranslatorType> TRANSLATOR_TYPE_CONFIG = BUILDER.comment("The translator.").defineEnum("translator_type",TranslatorType.DEFAULT,TranslatorType.values());
